...
export const TIERS_CONFIG: Record<TierLevel, TierInfo> = {
  ...
  platinum: {
    ...
    subtitle: 'Platinum',
    daysRequirement: '60–89 Clean Days',
    badgeLabel: 'Platinum',
  ...
  gold: {
    ...
    subtitle: 'Gold',
    daysRequirement: '30–59 Clean Days',
    badgeLabel: 'Gold',
  ...
  silver: {
    ...
    title: 'Rules student',
    subtitle: 'Silver',
    daysRequirement: '7–29 Clean Days',
  ...
  bronze: {
    ...
    title: 'Random trader',
    subtitle: 'Bronze',
    daysRequirement: '1–6 Clean Days',
  ...
  copper: {
    ...
    title: 'Gambler',
    subtitle: 'Copper',
    daysRequirement: 'Tilt Breach / 0 Days',
    badgeLabel: 'Gambler',
